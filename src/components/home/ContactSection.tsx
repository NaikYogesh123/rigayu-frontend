    ...
    return (
        <section id="contact" className="py-24 bg-background">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="bg-gradient-to-br from-apit-blue to-apit-dark-blue rounded-[3rem] overflow-hidden shadow-2xl shadow-apit-blue/20">
                    <div className="flex flex-col items-center justify-center p-12 lg:p-20 text-white space-y-12 text-center">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 w-full">
                            <div className="flex flex-col items-center">
                                ...
                                <p className="text-blue-200 text-sm max-w-xs">#2nd Floor, Manjunatha Complex, 11th Cross, C-Block, Building No. 36, MKK Main Road, Gayatri Nagar, Bangalore – 560021, Karnataka, India</p>
                            </div>
                            ...
                            <div className="flex flex-col items-center">
                                ...
                                <p className="text-blue-200 text-lg">info@rigayu.com</p>
                            </div>
                            ...
                            <div className="flex flex-col items-center">
                                ...
                                <p className="text-blue-200 text-lg font-bold italic text-apit-yellow">Toll Free: 9480340163</p>
                            </div>
                        </div>
                    </div>
                </div>
