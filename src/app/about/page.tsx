        ...
        <div className="min-h-screen bg-background">
            ...
            <section className="relative bg-surface py-14 overflow-hidden border-b border-border-color">
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
                    <h1 className="text-4xl md:text-5xl font-extrabold text-white mb-3 animate-in fade-in slide-in-from-bottom duration-700">
                        About Us
                    </h1>
                    <p className="text-lg text-gray-400 max-w-3xl mx-auto leading-relaxed animate-in fade-in slide-in-from-bottom duration-1000 delay-200">
            ...
            <section className="py-20">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center max-w-3xl mx-auto mb-16">
                        ...
                        <h3 className="text-4xl font-extrabold text-white mb-6">Core Values</h3>
