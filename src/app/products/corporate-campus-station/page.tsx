...
export const metadata: Metadata = {
    title: "Corporate Campus Station - RIGAYU Products",
    description: "A Rigayu smart machine designed for corporate campus environments, providing fresh and healthy sprout salads to professionals.",
};

export default function CorporateCampusStation() {
    return (
