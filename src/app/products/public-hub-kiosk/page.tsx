            ...
            <section className="relative bg-surface py-14 overflow-hidden border-b border-border-color">
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                    ...
                    <p className="text-lg text-gray-400 max-w-3xl leading-relaxed">
                        Healthy nutrition meets urban convenience
                    </p>
                </div>
            </section>
                        ...
                        <div className="space-y-8">
                            ...
                            <div>
                                ...
                                <ul className="space-y-3">
                                    {[
                                        "Optimized for shopping districts, railway stations, and transit hubs",
                                        "Weather-resistant and durable build for outdoor and semi-outdoor placement",
                                        "Eye-catching design to attract passing foot traffic",
                                        "Quick-serve mechanism ideal for on-the-go nutrition",
                                        "Smart inventory tracking for efficient restocking and management",
                                    ].map((feature, i) => (
